              ...
              <div className="space-y-3">
                {suggestions.map((u) => (
                  <div key={u.id} className="flex items-center gap-3 p-4 rounded-2xl bg-card border border-border hover:border-green-500/30 transition-all group">
                    <div className="flex-1 flex items-center gap-3 cursor-pointer" onClick={() => router.push(`/profile?id=${u.id}`)}>
              ...
              <div className="space-y-3">
                {friendRequests.map((req) => (
                  <div key={req.id} className="flex items-center gap-3 p-4 rounded-2xl bg-card border border-border">
                    <div className="flex-1 flex items-center gap-3 cursor-pointer" onClick={() => router.push(`/profile?id=${req.sender.id}`)}>
            ...
            {activeTab === 'sent' && (
              ...
              <div className="space-y-3">
                {sentRequests.map((req) => (
                  <div key={req.id} className="flex items-center gap-3 p-4 rounded-2xl bg-card border border-border">
                    <div className="flex-1 flex items-center gap-3 cursor-pointer" onClick={() => router.push(`/profile?id=${req.receiver.id}`)}>
              ...
              <div className="space-y-3">
                {friends.map((friend) => (
                  <div key={friend.id} className="w-full flex items-center gap-3 p-4 rounded-2xl bg-card border border-border hover:border-green-500/30 transition-all group">
                    <div className="flex-1 flex items-center gap-3 cursor-pointer" onClick={() => router.push(`/profile?id=${friend.id}`)}>
