          ...
          <div className="text-center py-12 text-muted-foreground">
            ...
            <div className="space-y-3">
              {results.map((u) => (
                ...
                >
                  <div className="relative cursor-pointer" onClick={() => router.push(`/profile?id=${u.id}`)}>
                    {u.profile_picture ? (
                  ...
                  <div className="flex-1 min-w-0 cursor-pointer" onClick={() => router.push(`/profile?id=${u.id}`)}>
